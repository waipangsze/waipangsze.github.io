...
## Idea: Fourier transform on fdda.nc

1. generate raw fdda.nc 
2. convert raw fdda.nc to k-fdda.nc with k-space
3. truncate wavelength less than 1000km
4. convert back to real space r-fdda.nc
5. apply this r-fdda.nc on simulation run
